    ...
    ClientsModule.registerAsync([
      {
        ...
        useFactory: (configService: ConfigService) => ({
          ...
          options: {
            package: configService.get<string>('INVITATION_SERVICE_PKG', 'invitation'),
            protoPath: join(__dirname, './../../../libs/proto/invitation.proto'),  // Path to the proto file
            url: configService.get<string>('INVITATION_SERVICE_URL', 'localhost:5002'),  // gRPC server URL
          },
        }),
