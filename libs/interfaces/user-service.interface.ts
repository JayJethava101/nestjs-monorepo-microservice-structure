...
export interface IUserService {
    ...
    updateUser(data: { id: string } & UpdateUserDto, metadata: Metadata): Observable<User|null>;
    deleteUser(data: { id: string }, metadata: Metadata): Observable<{ success: boolean }>;
    listUsers(data: { 
        page?: number;
        limit?: number;
        search?: string;
